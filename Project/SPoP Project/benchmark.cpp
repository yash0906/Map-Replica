...
int main()
{
	...
	for(int i=0;i<10000;i++)
	{
			...
			if((ans==false && itr != db.end()) || (ans==true && itr->second != sliceToStr(s_value) ))
				{
					incorrect = true;
					cout << i << "	" << x <<endl;
					// cout << "galti"<< "	"<< itr->second << itr->second.length() << "		" <<  sliceToStr(s_value) << endl;
				}
		}
		else if(x==1)
		{
			...
			strToSlice(key,s_key);
			strToSlice(value,s_value);
			cout << "before put" << s_value.data << endl;
			bool ans = kv.put(s_key,s_value);
			...
			if(check2 == false || value != sliceToStr(check))
				{
					...
					cout << sliceToStr(s_key) << endl;
					cout << sliceToStr(check) << endl;
					cout << i << "	" << x <<endl;
			...
			if(check2 == true)
				{
					...
					// cout << "x=2	" << i << endl;
					// cout << "origivalue		" << itr->second << endl;
					// cout << "origikey		" << itr->first << endl; 
					// cout << "gotkey		" << s_key.data << endl;
					// cout << "gotvalue		" << s_value.data << endl;
		...
		else if(x==3)
		{
			...
			Slice s_key,s_value;
			// cout << rem << endl;
			s_key.data=new char[65];
			s_value.data=new char[257];
			...
			if( itr->first != sliceToStr(s_key) || itr->second != sliceToStr(s_value))
				{
					...
					// cout << "x=3 	"<< i  << endl;
					// cout<< itr->first<<" "<< sliceToStr(s_key)<<endl;
				}
		}
		else if(x==4)
		{
